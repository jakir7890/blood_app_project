...
class BloodDonner extends StatefulWidget {
  const BloodDonner({Key? key}) : super(key: key);

  @override
  State<BloodDonner> createState() => _BloodDonnerState();
}

class _BloodDonnerState extends State<BloodDonner> {
  String? valueChoose1;
  String? valueChoose2;
  String? valueChoose3;
...
Future createUser(User user) async {
  final docUser = FirebaseFirestore.instance.collection('blood-donner').doc();
  user.id = docUser.id;
